<script>
    $(function(){
        ...
        $("#confirm_s").click(function(){
            document.getElementById('filter').action = "/maintain/work_order/third_party";
...
<div class='operate'>
    ...
    <a href="/maintain/work_order/third_party" class="btn btn-primary">清除查询</a>
</div>
</form>
    ...
    <div style="clear:right;"><?= $pagination ?></div>
            ...
            <table class="table table-striped table-bordered table-condensed">
                ...
                <tbody id="tbody">
                    ...
                    <td>
                        <a class="btn btn-primary btn-mini" href="third_party_status/<?= $data['id']?>">查看</a>
                        <a class="btn btn-primary btn-mini" href="#" onclick="confirm_jumping('点击关闭','/maintain/work_order/close_third_party/<?=$data['id']?>') ">关闭</a>
                    </td>
                    </tr>
                    <?php endforeach?>
                </tbody>
