<script>
    $(function(){
        ...
        $("#confirm_s").click(function(){
            document.getElementById('filter').action = "/maintain/work_order/confirme_orders";
...
<div class='operate'>
    ...
    <a href="/maintain/work_order/confirme_orders" class="btn btn-primary">清除查询</a>
</div>
</form>
    ...
    <div style="clear:right;"><?= $pagination ?></div>
            ...
            <table class="table table-striped table-bordered table-condensed">
                ...
                <tbody id="tbody">
                    ...
                    <td><a target='_blank' href="work_order_detail/<?= $data['id']?>">查看</a></td>
                    </tr>
                    <?php endforeach?>
                </tbody>
            </table>        
