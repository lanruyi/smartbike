         ...
         <div class="row">
            <div class="col-md-12">
               ...
               <ul class="page-breadcrumb breadcrumb">
                  ...
                  <li><a href="/newback/station/slist">工勘站点列表</a></li>
                  <li class="pull-right">
            ...
            <div class="portlet tabbable">
                <div class="portlet-title">
                    ...
                    <div class="pull-right">
                        ...
                        <a href="/newback/exploration/slist" class="btn btn-info btn-xs"> 取消筛选</a>
                    </div>
                </div>
                <div class="portlet-body">
                    <div class=row style="padding:10px 10px 0 10px">
                        <div class="col-xs-12"> 
                        <?= h_make_select(h_array_2_select($users),'user_id',$this->input->get('user_id'),"所有人员"); ?>
                        </div>
                    </div>
 ...
 <div class="row">
         <div class="col-xs-12">
            ...
            <table class="table table-bordered table-hover">
                 ...
                 <tr>
                     <td colspan=10>
                         <a href="/newback/exploration/single/<?= $gk_station["id"]?>">查看详情</a>
                     </td>
                 </tr>
            </table>
            <?}?>
