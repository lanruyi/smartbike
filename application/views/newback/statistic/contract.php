...
div.scmain li{float:left;padding:0px;list-style:none;}
div.scmain ul{float:left;padding:0px;list-style:none;}
...
<div>
        <div class="scmain" style="background-color:#fff">
            <div class="scright" style="height:100px;width:1000px">
                <h2> 所有合同总体统计 </h2>
                <li> 
