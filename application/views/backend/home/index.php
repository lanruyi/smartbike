...
<head>
   ...
   <link href="/static/assets/plugins/fullcalendar/fullcalendar/fullcalendar.css" rel="stylesheet" type="text/css"/>
   <link href="/static/assets/plugins/jqvmap/jqvmap/jqvmap.css" rel="stylesheet" type="text/css"/>
   <link href="/static/assets/plugins/jquery-easy-pie-chart/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css"/>
...
<body class="page-header-fixed">
   ...
   <div class="header navbar navbar-inverse navbar-fixed-top">
      ...
      <div class="header-inner">
         ...
         <img src="/static/assets/img/logo.png" alt="logo" class="img-responsive" />
         </a>
         ...
         <ul class="nav navbar-nav pull-right">
                  ...
                  <li>
                     <ul class="dropdown-menu-list scroller" style="height: 250px;">
                        <li>  
                           ...
                           <span class="photo"><img src="/static/assets/img/avatar2.jpg" alt=""/></span>
                           <span class="subject">
                        ...
                        <li>  
                           <a href="inbox.html?a=view">
                           <span class="photo"><img src="/static/assets/img/avatar3.jpg" alt=""/></span>
                           <span class="subject">
                        ...
                        <li>  
                           <a href="inbox.html?a=view">
                           <span class="photo"><img src="/static/assets/img/avatar1.jpg" alt=""/></span>
                           <span class="subject">
                           <span class="from">陈相</span>
                           <span class="time">2 hrs</span>
                           </span>
                           <span class="message">
            ...
            <li class="dropdown user">
               <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
               <img alt="" src="/static/assets/img/avatar3_small.jpg"/>
               <span class="username">陈小相</span>
      ...
      <div class="page-sidebar navbar-collapse collapse">
         ...
         <ul class="page-sidebar-menu">
            ...
            <li class="">
               <a href="javascript:;">
               <i class="icon-cogs"></i> 
               <span class="title">基 站</span>
               <span class="arrow "></span>
               </a>
               <ul class="sub-menu">
                  <li >
                     <a href="layout_language_bar.html">
                     <span class="badge badge-important">new</span>基站列表</a>
                  </li>
                  <li >
   ...
   <script src="/static/assets/scripts/tasks.js" type="text/javascript"></script>  
