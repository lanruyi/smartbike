...
<div class="add_blog_block">
    <?= form_open("/backend/blog/station_blog_add/".$station['id'],"",""); ?>
    <ul class='title'>
        <li class='title'>
        <font>添加日志</font>
        </li>
...
<div class='operate'>
    ...
    <? if($station){ ?>
        <a href="/backend/blog/index?station_id=<?= $station['id'] ?>" class="btn btn-primary">清除查询</a>
      <?}else{?>
        <a href="/backend/blog/index" class="btn btn-primary">清除查询</a>
      <?}?>
</div>
</form>
